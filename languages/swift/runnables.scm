  ...
  (modifiers
    (attribute
      (user_type
        (type_identifier) @run
        (#eq? @run "Suite"))))
  name: (type_identifier) @_name @SWIFT_TEST_CLASS) @_swift-testing-suite
    ...
    (modifiers
      (attribute
        (user_type
          (type_identifier) @run
          (#eq? @run "Test"))))
    name: (simple_identifier) @_name @SWIFT_TEST_FUNC) @_swift-testing-bare-func)
      ...
      (modifiers
        (attribute
          (user_type
            (type_identifier) @run
            (#eq? @run "Test"))))
      name: (simple_identifier) @_name @SWIFT_TEST_FUNC))) @_swift-testing-member-func
...
((class_declaration
  ...
  (inheritance_specifier
    inherits_from: (user_type
      (type_identifier) @run
      (#eq? @run "XCTestCase")))) @_swift-xctest-class
...
((class_declaration
  ...
  (inheritance_specifier
    inherits_from: (user_type
      (type_identifier) @_superclass_name
      (#eq? @_superclass_name "XCTestCase")))
  body: (class_body
    (function_declaration
      name: (simple_identifier) @_name @SWIFT_TEST_FUNC @run
      (#match? @run "^test")))) @_swift-xctest-func
...
((class_declaration
  ...
  (inheritance_specifier
    inherits_from: (user_type
      (type_identifier) @run
      (#eq? @run "QuickSpec")))) @_swift-test-quick-spec
...
((class_declaration
  ...
  (inheritance_specifier
    inherits_from: (user_type
      (type_identifier) @run
      (#eq? @run "AsyncSpec")))) @_swift-test-async-spec
